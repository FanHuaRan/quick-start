...
/**
 * Created by Huaran Fan on 2019/3/6
 *
 * @description
 */
public abstract class RateLimiter {
    ...
    public static RateLimiter create(double permitsPerSecond,int maxBurstSeconds){
        RateLimiter rateLimiter = new SmoothRateLimiter.SmoothBursty(SleepingStopwatch.createFromSystemTimer(), maxBurstSeconds /* maxBurstSeconds */);
